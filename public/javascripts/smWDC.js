// function requestSurveyMonkeyLogin(){
// 	var OAuth_link = "https://api.surveymonkey.net/oauth/authorize";
...
$(document).ready(function() {
	...
	$('#login').click(function(){
		...
		var url = SM_API_BASE + AUTH_CODE_ENDPOINT + '?' + url_params.redirect_uri;
